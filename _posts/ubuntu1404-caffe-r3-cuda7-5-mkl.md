...
![](/images/caffe/cuDNN Download.png)
...
export PATH
```
![](/images/caffe/caffe_profile.png)
...
![](/images/caffe/mkl_Download_1.png)
选择社区版本Licensing
![](/images/caffe/mkl_Download_2.png)
填写信息后，会下载链接和激活码到你注册邮箱。
![](/images/caffe/mkl_Download_3.png)
...
sudo sh install.sh
```
![](/images/caffe/mkl_install.png)
![](/images/caffe/mkl_ativate.png)
![](/images/caffe/mkl_complete.png)
**注意**： 安装完成后需要添加library路径, 创建`/etc/ld.so.conf.d/intel_mkl.conf`文件， 在文件中添加内容
```
/opt/intel/lib/intel64
/opt/intel/mkl/lib/intel64
```
![](/images/caffe/intel_mkl_conf.png)
...
![](/images/caffe/matlab_location.png)
##  编译Caffe
###  编译主程序
...
![](/images/caffe/makeruntest_begin.png)
![](/images/caffe/makeruntest_finish.png)
