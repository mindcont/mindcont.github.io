...
Linux架构图
![](/images/coding/ubuntu/linux_kernel.jpg)

其发行版本
![](/images/coding/ubuntu/linux.jpg)

各发行版的特点
![](/images/coding/ubuntu/linux-2.jpg)
...
```
![](/images/coding/ubuntu/firefox_test.png)

如果这时能够正常访问 https://www.google.com/ncr ， 即说明 shadowsocks安装和你的配置文件都没有问题。

![](/images/coding/ubuntu/browser.png)
...
```
![](/images/coding/ubuntu/autoproxy.png)
