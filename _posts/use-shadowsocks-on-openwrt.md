...
![](/images/ubuntu/openwrt/welcome.png)
...
![](/images/ubuntu/openwrt/dhcp.png)

勾选“忽略解析文件”(ignore resolve file), 保存并应用
![](/images/ubuntu/openwrt/dhcp_hosts.png)
...
保存并应用
![](/images/ubuntu/openwrt/chinadns.png)
...
![](/images/ubuntu/openwrt/shadowsocks_udp.png)
...
```
如下图所示
![](/images/ubuntu/openwrt/iptable.png)
