...
![](/images/iot/openwrt/shadowsocks-install.png)
chinadns 的安装过程类似。
...
![](/images/iot/openwrt/dhcp.png)

勾选“忽略解析文件”(ignore resolve file), 保存并应用
![](/images/iot/openwrt/dhcp_hosts.png)
...
保存并应用
![](/images/iot/openwrt/chinadns.png)
...
![](/images/iot/openwrt/shadowsocks_udp.png)
...
```
如下图所示
![](/images/iot/openwrt/iptable.png)
