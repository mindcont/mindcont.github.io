...
![](http://static.mindcont.com/blog/images/ubuntu/openwrt/shadowsocks-install.png)
chinadns 的安装过程类似。
...
![](http://static.mindcont.com/blog/images/ubuntu/openwrt/dhcp.png)

勾选“忽略解析文件”(ignore resolve file), 保存并应用
![](http://static.mindcont.com/blog/images/ubuntu/openwrt/dhcp_hosts.png)
...
保存并应用
![](http://static.mindcont.com/blog/images/ubuntu/openwrt/chinadns.png)
...
![](http://static.mindcont.com/blog/images/ubuntu/openwrt/shadowsocks_udp.png)
...
```
如下图所示
![](http://static.mindcont.com/blog/images/ubuntu/openwrt/iptable.png)
