...
gpg --gen-key　
```
![](http://static.mindcont.com/blog/images/coding/ubuntu/ppa/gpgkey.png)
之后你应该会看到如下信息：
```
...
![](http://static.mindcont.com/blog/images/coding/ubuntu/ppa/pbuilder.png)
...
![](http://static.mindcont.com/blog/images/coding/ubuntu/ppa/upload_gpg_key_1.png)

然后填写刚才我们查找的pub字段，密钥指纹中的字符串
![](http://static.mindcont.com/blog/images/coding/ubuntu/ppa/upload_gpg_key_2.png)
...
![](http://static.mindcont.com/blog/images/coding/ubuntu/ppa/build.png)

编译完成后，就可以通过ppa源进行安装了
![](http://static.mindcont.com/blog/images/coding/ubuntu/ppa/build_success.png)
```
