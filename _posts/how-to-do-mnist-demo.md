...
<!--more-->
![](/images/research/caffe/asamples.gif)
...
```
训练网络
![](/images/research/caffe/lenet_train_test.png)

测试／部署网络，即用于测试，和训练网络区别在于没有标签的输入，只有前向传播过程。
![](/images/research/caffe/lenet.png)
