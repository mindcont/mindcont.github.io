...
![](http://7xn2mk.com1.z0.glb.clouddn.com/blog/images/resources/cnn_1d_conv.png)
...
### 二维卷积
![](http://7xn2mk.com1.z0.glb.clouddn.com/blog/images/resources/cnn_Convolution_schematic.gif)
这里不细说，下面会细说。
### 三维卷积
![](http://7xn2mk.com1.z0.glb.clouddn.com/blog/images/resources/cnn_3d_conv.png)
...
![](http://7xn2mk.com1.z0.glb.clouddn.com/blog/images/resources/cnn_Pooling_schematic.gif)
...
如下图所示：
![](http://7xn2mk.com1.z0.glb.clouddn.com/blog/images/resources/cnn_2d_conv.png)
...
![](http://7xn2mk.com1.z0.glb.clouddn.com/blog/images/resources/cnn_dx.png)
对应的求解，发现这个操作类似于卷积。但是对于`x_{0,0}`的求解，需要对delta进行阔边以方便直接使用卷积操作。如下图所示:
![](http://7xn2mk.com1.z0.glb.clouddn.com/blog/images/resources/cnn_dx_border.png)

接下来是对w求导，得到更新梯度。计算也是一样的，找到w参与的点积计算，拿到导数合并一下就可以了。如下图所示，我们发现同样可以用卷积操作来表示：
![](http://7xn2mk.com1.z0.glb.clouddn.com/blog/images/resources/cnn_dw.png)

那么我们可以联系到线性回归，以方便我们记忆了：
![](http://7xn2mk.com1.z0.glb.clouddn.com/blog/images/resources/cnn_bp.png)
...
![](http://7xn2mk.com1.z0.glb.clouddn.com/blog/images/resources/cnn_pool.png)
...
![](http://7xn2mk.com1.z0.glb.clouddn.com/blog/images/resources/cnn_im2col.png)
简单的说，就是把操作转为向量的形式。那么计算就和线性回归一样了，如下：
![](http://7xn2mk.com1.z0.glb.clouddn.com/blog/images/resources/cnn_im2col_2.png)
对于误差反馈，我们还需要把反馈的误差，再转回到二维图像的形式，也就是col2im，如下图所示：
![](http://7xn2mk.com1.z0.glb.clouddn.com/blog/images/resources/cnn_col2im.png)
转换的时候，是不断的累加的。
